class TeethAnimationPage
  ...
  show: ->
    ...
    @tm.to( @container, 1.5,{autoAlpha: 1, ease: Ease.easeIn}, t+=2.50)
    ...
    @tm.to( @h1, 1,autoAlpha: 1, scrambleText:{text:"brosse <br>à dents", chars:"0123456789", revealDelay:0.5, tweenLength:false, ease:Linear.easeNone},t+=.3)
    @tm.to( @h3, .5,{autoAlpha: 1,x: 0, ease: Back.easeOut}, t+=.2)

    @tm.staggerFromTo(@shapes, .01,  {drawSVG:"50% 50%"},{drawSVG:"100%"}, 0.2,t+=.1)
        .staggerTo(@shapes, .05, {stroke:"none", scale:1, opacity:0}, 0.2,t+=.2)
    # @tm.to(@path1, 0.5, {stroke:"none", scale:1, opacity:0}, 0.4,t+=.4) 

    @tm.to(@path0, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path1, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path2, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path3, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path4, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path5, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path6, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path7, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path8, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path9, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path10, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path11, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path12, 0.05, {fill:"#F2F4F4", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
    @tm.to(@path13, 0.05, {fill:"#214E61", scale:1, opacity:1,ease: Ease.easeOut},t+=.2)
