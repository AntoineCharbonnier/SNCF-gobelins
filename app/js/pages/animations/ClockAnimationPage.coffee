class ClockAnimationPage
  constructor: (@container) ->
    ...
    @container = "#{@container}"
    # console.log "Clock containrer",@container
    ...
    # @addidas     = "#{@container} li.Clock__addidas"
    # @google      = "#{@container} li.Clock__google"
    # @samsung     = "#{@container} li.Clock__samsung"
    # @microsoft   = "#{@container} li.Clock__microsoft"

    # @ClockLogo = "#{@container} li"

    # @bg          =  "#{@container} .Clock--background"
  ...
  prepare: ->
    ...
    # TweenMax.set @ClockLogo, autoAlpha: 0, y: 100
  ...
  show: ->
    ...
    # @tm.staggerTo(@ClockLogo, .5, {autoAlpha: 1, y: 0, ease: Back.easeOut}, .2, t+=.3)
