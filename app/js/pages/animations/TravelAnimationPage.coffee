class TravelAnimationPage
  ...
  show: ->
    ...
    @tm.to(@h1, 1,autoAlpha: 1, scrambleText:{text:"Horaires ", chars:"why are you late ?", revealDelay:0.5, tweenLength:false, ease:Linear.easeNone},t+=1.5)
...
module.exports = TravelAnimationPage
